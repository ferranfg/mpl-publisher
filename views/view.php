<div class="wrap mpl">
	...
	<h2 id="mpl-logo"><?php echo $title; ?></h2>
				...
				<div class="form-wrap tab-content">
					...
					<div class="tab-pane clearfix" id="book-settings">
						...
						<div class="form-field">
							...
							<input type="hidden" name="coverSrc" value="<?php echo $coverSrc; ?>">
					...
					<div class="form-field">
						...
						<select name="format" id="format">
							...
							<option value="mrkdn" <?php echo $format == "mrkdn" ? "selected='selected'" : ''; ?>>Markdown</option>
						</select>
