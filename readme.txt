...
= 2.21.0 =
- Updated EPUB and Word dependencies
...
- Fixed navbar responsiveness for better mobile compatibility.
...
= 2.8.2 =
- Fix error with ampersand and epub validation
- Add support for Zotpress and Zotero references
