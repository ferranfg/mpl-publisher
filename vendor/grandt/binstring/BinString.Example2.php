    ...
    <body>
        ...
        <table>
            ...
            <tr class="new">
                ...
                <td><?= test(\com\grandt\BinStringStatic::_strrpos($mbStr, $mbNeedle), 6) ?></td>
            </tr>
            <tr>
                <td>no</td>
                <td><?= test(strrpos($isoStr, $isoNeedle), 5) ?></td>
                <td><?= test(mb_strrpos($isoStr, $isoNeedle, 0, 'latin1'), 5) ?></td>
                <td><?= test(\com\grandt\BinStringStatic::_strrpos($isoStr, $isoNeedle), 5) ?></td>
            </tr>
            ...
            <tr class="new">
                ...
                <td><?= test(\com\grandt\BinStringStatic::_substr($mbStr, 6), "\xC3\xB8\xC3\xA5") ?></td>
            </tr>
            <tr>
                <td>no</td>
                <td><?= test_enc(substr($isoStr, 5), "\xF8\xE5") ?></td>
                <td><?= test_enc(mb_substr($isoStr, 5, mb_strlen($isoStr, 'latin1'), 'latin1'), "\xF8\xE5") ?></td>
                <td><?= test_enc(\com\grandt\BinStringStatic::_substr($isoStr, 5), "\xF8\xE5") ?></td>
            </tr>
            ...
            <tr class="new">
                ...
                <td class="expectFail"><?= test(\com\grandt\BinStringStatic::_strtolower($mbStr), $mbStr_lower) ?></td>
            </tr>
            <tr>
                <td>no</td>
                <td class="expectFail"><?= test_enc(strtolower($isoStr), $isoStr_lower) ?></td>
                <td><?= test_enc(mb_strtolower($isoStr, 'latin1'), $isoStr_lower) ?></td>
                <td class="expectFail"><?= test_enc(\com\grandt\BinStringStatic::_strtolower($isoStr), $isoStr_lower) ?></td>
            </tr>
            ...
            <tr class="new">
                ...
                <td class="expectFail"><?= test(\com\grandt\BinStringStatic::_strtoupper($mbStr), $mbStr_upper) ?></td>
            </tr>
            <tr>
                <td>no</td>
                <td class="expectFail"><?= test_enc(strtoupper($isoStr), $isoStr_upper) ?></td>
                <td><?= test_enc(mb_strtoupper($isoStr, 'latin1'), $isoStr_upper) ?></td>
                <td class="expectFail"><?= test_enc(\com\grandt\BinStringStatic::_strtoupper($isoStr), $isoStr_upper) ?></td>
            </tr>
            ...
            <tr class="new">
                ...
                <td><?= test(\com\grandt\BinStringStatic::_substr_count($mbStr, $mbNeedle), 1) ?></td>
            </tr>
            <tr>
                <td>no</td>
                <td><?= test_enc(substr_count($isoStr, $isoNeedle), 1) ?></td>
                <td><?= test_enc(mb_substr_count($isoStr, $isoNeedle, 'latin1'), 1) ?></td>
                <td><?= test_enc(\com\grandt\BinStringStatic::_substr_count($isoStr, $isoNeedle), 1) ?></td>
            </tr>
